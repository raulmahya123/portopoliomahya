...
const Projects = () => {
    const ProjectList = [
        ...
        },
        {
            ...
            technology: "Golang,React JS,MongoDB & heroku",
        },
        {
            href: "https://mydigilearn.id",
            type: "Backend Development & R&D",
            image: "/images/projects/mydigileran.png",
            title: "Mydigilearn",
            technology: "Hapi JS & Golang",
            description: "Developing a learning platform under Telkom Corpu and open to the public, utilizing Hapi JS and Golang.",
        },
        {
            ...
            technology: "Golang",
            description: "Creating a specialized module integrated with Golang and MongoDB, accessible to everyone.",
        },
        {
            ...
            technology: "Hapi JS & Golang",
            description: "Building a digiAI recognition project using Large Language Models (LLM) with Golang and Gorilla Mux.",
        },
        {
            href: "https://kidneys8.wordpress.com",
            type: "CEO",
            image: "/images/projects/kodeys.png",
            title: "Kodeys",
            technology: "Wordpress",
            description: "Developing an exclusive IT news platform in Golang, providing the latest updates, trends, and insights in the technology industry.",
        },
        {
            ...
            technology: "Golang & Xendit",
            description: "Developing a backend system in Golang for a payment gateway using Xendit and Google for payment notifications",
        },
    ];
